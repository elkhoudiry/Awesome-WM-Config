...
userName = string.gsub(io.popen("whoami"):read("*a"), "\n", "")
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ modkey }, "x",
        function()
            awful.prompt.run {
                prompt       = "Run Lua code: ",
                textbox      = awful.screen.focused().run_widget.widget,
    ...
    awful.key({ modkey }, "r", function() awful.screen.focused().run_widget[1][2][1]:run() end,
...
ruled.client.connect_signal("request::rules", function()
    ...
    ruled.client.append_rule {
        rule       = { class = "com-ryinex-accountant-desktop-application-MainKt" },
        properties = { screen = 2 }
    }
end)
-- }}}
...
do
    local autostarts = {
        "lxpolkit &", "flameshot", "arandr", "mictray", "slack", "discord", "picom --backend glx", "thunderbird"
    }
