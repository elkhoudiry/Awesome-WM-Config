...
function theme.slider(value, max)
    return util_widgets.slider_text_value(value, max, theme)
end

function theme.title_and_close(title) return util_widgets.title_and_close(title) end
